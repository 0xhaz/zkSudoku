...
describe("Sudoku circuit", () => {
  ...
  it("Should fail because theres is a number out of bounds", async () => {
    // The number 10 in the firsts row of solved is > 9
    let input = {
      unsolved: [
        [0, 0, 0, 0, 0, 6, 0, 0, 0],
        [0, 0, 7, 2, 0, 0, 8, 0, 0],
  ...
  it("Should fail because unsolved is not the initial state of solved", async () => {
  ...
  it("Should fail due to repeated numbers in a row", async () => {
  ...
  it("Should fail due to repeated numbers in a column", async () => {
  ...
  it("Should fail due to repeated numbers in a square", async () => {
